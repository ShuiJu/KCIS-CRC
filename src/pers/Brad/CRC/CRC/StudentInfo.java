...
public class StudentInfo implements StanderStudent{
	 ...
	 */
	public StudentInfo(StudentID ID) throws NumberFormatException{
		setID(ID);
		fillBlank();
	}
	 ...
	 */
	public StudentInfo(StudentID ID,String name){
		setID(ID);
		this.name=name;
		fillBlank();
	}
	 ...
	 * @param ImageURL
	 */
	public StudentInfo(StudentID ID,String name,URL ImageURL){
		setID(ID);
		this.name=name;
	 ...
	 * 
	 * @param studentID - the new ID, Student ID only
	 * @throws NumberFormatException while the ID in come are having some problem
	 */
	@Override
	public void setID(final StudentID studentID){
		this.ID=studentID;
	}
